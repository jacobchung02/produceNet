...
for batch_size in batch_sizes:
    ...
    for threads in cpu_threads:
        ...
        # Save the CPU model
        torch.save(nn_model_cpu.state_dict(), f"{threads}threadcpu_{batch_size}.pth")
    ...
    # Save the GPU model
    torch.save(nn_model_gpu.state_dict(), f"gpu_{batch_size}.pth")

    # Plot training times for the batch size
    if batch_size == 128:
